...
function openTabRight(evt, tabName) {
	...
	tabcontentRightInfo = document.getElementsByClassName("tabcontentRightInfo");
    for (i = 0; i < tabcontentRightInfo.length; i++) {

        if (tabcontentRightInfo[i].id != tabName.toString())
            tabcontentRightInfo[i].style.display = "none";
    }
}
...
$('.tabcontentRightInfo').perfectScrollbar();

    ...
    var AnnotationController = function(worldWindow, queryParameters, control) {
        ...
        this.magSlider.slider({
            ...
            slide: function(event, ui) {
				...
				var delta=max-min;
				var escalon=delta/4;
				var segundo=min+escalon;
				let segundo1=segundo.toFixed(1);
				var tercero=segundo+escalon;
				let tercero1=tercero.toFixed(1);
				var cuarto=tercero+escalon;
				let cuarto1=cuarto.toFixed(1);
				
                $("#magSliderValue").html(ui.values[0].toString() + " to " +
                    ui.values[1].toString() + " Richter");
				$("#primerNivel").html(min.toString() + " - " +
                    segundo1.toString());
				$("#segundoNivel").html(segundo1.toString() + " - " +
                    tercero1.toString());
				$("#tercerNivel").html(tercero1.toString() + " - " +
                    cuarto1.toString());
				$("#cuartoNivel").html(cuarto1.toString() + " - " +
                    max.toString());
				$("#primerNivel1").html(min.toString() + " - " +
                    segundo1.toString());
				$("#segundoNivel1").html(segundo1.toString() + " - " +
                    tercero1.toString());
				$("#tercerNivel1").html(tercero1.toString() + " - " +
                    cuarto1.toString());
				$("#cuartoNivel1").html(cuarto1.toString() + " - " +
                    max.toString());
